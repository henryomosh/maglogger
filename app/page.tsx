...
import { Users, Calendar, Music, DollarSign, TrendingUp, Clock, Mic, Radio } from "lucide-react"
          ...
          return (
            <div className="space-y-6">
                ...
                {stats.map((stat) => (
                  <Card key={stat.title}>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground font-serif">{stat.change}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="font-sans font-bold">Recent Activity</CardTitle>
                    <CardDescription className="font-serif">Latest updates from your radio station</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription className="font-serif">Today's scheduled programming</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        <div key={index} className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-serif font-medium">{show.time}</span>
                            </div>
                            <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="font-serif">Common tasks for {user?.role}s</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Add or edit DJ profiles</p>
                          </div>
                        </div>
                        <div
                          className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Update programming</p>
                          </div>
                        </div>
                        <div
                          className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Check performance</p>
                          </div>
                        </div>
                      </>
                    ) : (
                      <>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Manage your music</p>
                          </div>
                        </div>
                        <div
                          className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">View upcoming shows</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 p-3 border rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Start broadcasting</p>
                          </div>
                        </div>
                      </>
                    )}
